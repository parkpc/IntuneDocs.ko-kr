...
description: "Intune에서 관리하거나 모니터링하는 장치에서 암호 코드 제거 작업을 사용하여 암호를 제거하거나 다시 설정합니다."
keywords: 
...
- Windows Phone 8.1에서 Azure AD에 조인되지 않은 Windows 10 크리에이터스 업데이트 및 Windows 10 크리에이터스 업데이트 이상
- iOS
...
4. 관리하는 장치 목록에서 장치를 선택하고 **자세히...**를 선택한 다음, **암호 제거** 장치 원격 작업을 선택합니다.
