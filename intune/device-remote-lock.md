...
**원격 잠금** 장치 작업을 수행하면 장치가 잠깁니다. 잠금을 해제하려면 장치 소유자가 암호를 입력해야 합니다. PIN 또는 암호 설정이 있는 장치를 원격으로 잠글 수 있습니다. PIN 또는 암호가 없는 장치를 원격으로 잠글 수 없습니다.
...
> [!NOTE]
> macOS 장치의 경우 6자리 복구 PIN을 설정합니다. 잠기면 **장치 개요**에는 다른 장치 작업이 전송될 때까지 PIN이 표시됩니다.
...
이 작업의 상태를 보려면 **장치 작업**(Microsoft Intune > 장치)을 선택합니다. 장치를 관리할 수 있는 추가 작업은 [사용 가능한 작업](device-management.md)을 참조하세요.