...
iOS 앱 스토어는 회사에서 실행하려는 앱의 라이선스를 여러 개 구매하는 기능을 제공합니다. 앱의 여러 복사본을 구매하면 구매한 앱의 여러 복사본을 추적하는 관리 오버헤드를 줄일 수 있습니다.
...
| 2 | 회사 – 사용이 허가된 사용자(감독되지 않은 장치)     | 지원                                                                                               | 지원                                           | 지원                                 |
| 3 | 회사 – 사용이 허가된 사용자(감독된 장치)         | 지원                                                                                               | N                                           | 지원                                 |
| 4 | BYOD – 사용이 허가된 장치                           | N                                                                                               | 지원                                           | N                                 |
| 5 | 회사 – 사용이 허가된 장치(감독되지 않은 장치)                           | N                                                                                               | 지원                                           | N                                 |
