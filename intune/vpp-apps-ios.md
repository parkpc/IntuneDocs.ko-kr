...
1. **Mobile Apps** 워크로드에서 **관리** > **사용이 허가된 앱**을 선택합니다.
...
**필수** 할당 작업을 선택해야 합니다. 또한 2017년 1월 이후에 만든 새 테넌트에도 장치 그룹에 할당하는 기능을 사용할 수 있습니다. 테넌트가 이 날짜 전에 만들어졌고 VPP 앱을 장치 그룹에 할당할 수 없는 경우 Intune 지원에 문의하세요.
