...
Intune 설정의 세부 정보를 살펴보기 전에 조직의 모바일 장치 관리 요구 사항을 검토해 보겠습니다. 현재 MDM 공급자의 활성 사용자에 대한 보고서를 실행하여 중요한 사용자 그룹을 확인하는 것이 유용할 수 있습니다. 그러면 아래 [MDM 요구 사항 평가 섹션](migration-guide-prepare.md#assess-mdm-requirements)의 질문 검토를 시작할 수 있습니다.
