...
-   [조건부 액세스](/intune/conditional-access)에 대해 자세히 알아보세요.
...
[조건부 액세스를 사용하는 일반적인 방법](/intune/conditional-access-intune-common-ways-use).
...
-   [Intune과 함께 온-프레미스 Exchange 커넥터 설치](/intune/exchange-connector-install)

-   [Exchange Online에 대한 앱 기반 조건부 액세스 정책 설정](/intune/app-based-conditional-access-intune-exchange-online-create)

-   [SharePoint Online에 대한 앱 기반 조건부 액세스 정책 설정](/intune/app-based-conditional-access-intune-sharepoint-online-create)

-   [최신 인증(ADAL)을 사용하지 않는 앱 차단](/intune/app-modern-authentication-block)
