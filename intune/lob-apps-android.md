---
title: Microsoft Intune에 Android LOB(기간 업무) 앱을 추가하는 방법
titlesuffix: ''
...
> [!Note]
> Google Play for Work 스토어에서 LOB(기간 업무) 앱에 대한 자세한 내용은 [Google Play for Work 스토어에서 LOB(기간 업무) 앱으로 작업하기](apps-add-android-for-work.md?#working-with-a-line-of-business-app-from-the-google-play-for-work-store)를 참조합니다. 
...
2. **앱 패키지 파일** 칭에서 찾아보기 단추를 선택하고 확장명 **.apk**가 포함된 Android 설치 파일을 선택합니다.
