...
회사의 앱 및 장치 사용자(회사의 직원)에게는 여러 앱 요구 사항이 있습니다. Intune에 앱을 추가하고 직원이 사용할 수 있기 전에 앱의 몇 가지 기본 항목을 평가하고 이해해야 합니다. Intune에 사용 가능한 다양한 형식의 여러 앱을 이해해야 합니다. 필요한 플랫폼 및 직원에 필요한 기능 등 앱 요구 사항을 평가해야 합니다. 또한 Intune을 사용하여 장치(앱 포함)를 관리할지, 아니면 장치를 관리하지 않고 intune에서 앱을 관리할지를 결정해야 합니다. 다른 앱과 다른 기능이 필요한 직원을 결정해야 합니다. 이 아티클에서 제공하는 정보는 시작하는 데 도움이 됩니다.

## <a name="app-types-in-microsoft-intune"></a>Microsoft Intune의 앱 형식

Intune은 다양한 종류의 앱을 지원합니다. 사용 가능한 옵션은 앱 유형마다 다릅니다. Intune을 사용하여 다음 앱 유형을 추가하고 지정할 수 있습니다.

| **앱 형식**                                     | **설치**                                                                  | **업데이트**                       |
|------------------------------------------ |----------------------------------------------------------------------------   |---------------------------    |
| 저장소의 앱(스토어 앱)          | Intune이 장치에 앱 설치                                       | 앱 업데이트가 자동     |
| 사내에서 작성한 앱(기간 업무)  | Intune이 장치에 앱 설치(관리자가 설치 파일 제공)    | 관리자가 앱 업데이트       |
| 기본 제공된 앱(기본 제공 앱)    | Intune이 장치에 앱 설치                                       | 앱 업데이트가 자동     |
| 웹의 앱(웹 링크)                | Intune이 장치 홈 화면에 웹앱의 바로 가기 생성          | 앱 업데이트가 자동     |

### <a name="specific-app-type-details"></a>특정 앱 형식 세부 정보
 
다음 표에서는 Microsoft Intune에서 특정 앱 형식 및 **앱 추가** 블레이드에서 추가하는 방법을 나열합니다.

| **앱 특정 형식**                         | **일반 형식**             | **앱 특정 절차**                                                                                                                                                 |
|---------------------------------------------|------------------------------|-------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| Android 스토어 앱                        | 스토어 앱                  | **Android**를 **앱 형식**으로 선택하고 앱에 Google Play 스토어 URL을 입력합니다.                                                                                       |
| iOS 스토어 앱                            | 스토어 앱                  | **iOS**를 **앱 형식**으로 선택하고, 앱을 검색하고, Intune 내에서 앱을 선택합니다.                                                                                     |
| Windows Phone 8.1 스토어 앱              | 스토어 앱                  | **Windows Phone 8.1**을 **앱 형식**으로 선택하고 앱에 대한 Microsoft Store URL을 입력합니다.                                                                               |
| Microsoft Store 앱                      | 스토어 앱                  | **Windows**를 **앱 형식**으로 선택하고 앱에 대한 Microsoft Store URL을 입력합니다.                                                                                         |
| Android for Work 앱                     | 스토어 앱                  | Google Play for Work 스토어에서 Android for Work 앱을 찾고 승인합니다.                                                                                        |
| Windows 10용 Office 365 앱            | 스토어 앱(Office 365)     | **Office 365 제품군** 아래에서 **Windows 10**을 **앱 형식**으로 선택한 다음, 설치하려는 Office 365 앱을 선택합니다.                                                |
| macOS용 Office 365 앱                 | 스토어 앱(Office 365)     | **Office 365 제품군** 아래에서 **macOS**를 **앱 형식**으로 선택한 다음, Office 365 앱 제품군을 선택합니다.                                                                     |
| Android LOB(기간 업무) 앱       | LOB(기간 업무) 앱 | **기간 업무** 앱을 **앱 형식**으로 선택하고, **앱 패키지 파일**을 선택한 다음, 확장명이 **.apk**인 Android 설치 파일을 입력합니다.                    |
| iOS LOB(기간 업무) 앱           | LOB(기간 업무) 앱 | **기간 업무** 앱을 **앱 형식**으로 선택하고, **앱 패키지 파일**을 선택한 다음, 확장명이 **.ipa**인 iOS 설치 파일을 입력합니다.                        |
| Windows Phone LOB(기간 업무) 앱 | LOB(기간 업무) 앱 | **기간 업무** 앱을 **앱 형식**으로 선택하고, **앱 패키지 파일**을 선택한 다음, 확장명이 **.xap**인 iOS 설치 파일을 입력합니다.                        |
| Windows LOB(기간 업무) 앱       | LOB(기간 업무) 앱 | 기간 업무 앱을 앱 형식으로 선택하고, 앱 패키지 파일을 선택한 다음, 확장명이 **.msi**, **.appx** 또는 **.appxbundle**인 iOS 설치 파일을 입력합니다. |
| 기본 제공 iOS 앱                          | 기본 제공 앱               | **기본 제공 앱**을 **앱 형식**으로 선택한 다음, 제공된 앱 목록에서 기본 제공 앱을 선택합니다.                                                                  |
| 기본 제공 Android 앱                      | 기본 제공 앱               | **기본 제공 앱**을 **앱 형식**으로 선택한 다음, 제공된 앱 목록에서 기본 제공 앱을 선택합니다.                                                                  |
| 웹앱                                  | 웹앱                    | **웹 링크**를 **앱 형식**으로 선택하고 웹앱을 가리키는 올바른 URL을 입력합니다.                                                                                        |

   
**모바일 앱** > **앱** > **추가**를 선택하여 Microsoft Intune에서 앱을 추가할 수 있습니다. **앱 추가** 블레이드가 표시되고 **앱 형식**을 선택할 수 있습니다. 
...
- **스토어의 앱** - 스토어 앱은 Microsoft Store, iOS 스토어 또는 Android 스토어에 업로드된 앱입니다. 스토어 앱의 공급자는 앱 업데이트를 유지 관리 및 제공합니다. 관리자는 Intune을 사용하여 스토어 목록에서 앱을 선택하고 사용자가 사용할 수 있는 앱으로 추가합니다.
...
- **비즈니스용 Microsoft Store(Windows 10)** - 비즈니스용 Microsoft Store는 조직에서 사용할 앱을 찾아서 개별적으로 또는 대량으로 구입할 수 있는 위치를 제공합니다. 스토어를 Microsoft Intune에 연결하여 Azure Portal에서 대량 구매 앱을 관리할 수 있습니다. 자세한 내용은 [비즈니스용 Microsoft 스토어에서 앱 관리](windows-store-for-business.md)를 참조하세요.
...
4. **모바일 앱** 워크로드의 **설정** 섹션에서 **앱 범주**를 선택합니다. 
