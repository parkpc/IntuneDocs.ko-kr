...
2. **[続行]** をタップします。
3. デバイスが登録されていることを Intune が確認できるようにするため、デバイスのシリアル番号の最後の 4 文字を入力します。 シリアル番号を検索するには、「[How do I find the serial number on my device? (デバイスのシリアル番号を検索する方法)](how-do-i-find-the-serial-number-on-my-device-ios.md)」を参照してください。.
