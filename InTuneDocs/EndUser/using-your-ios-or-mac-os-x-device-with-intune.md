...
이 섹션의 정보는 사용자의 Intune 회사 포털 설치 및 iOS 장치에 대한 장치 등록에 도움이 됩니다.
...
이 섹션에서는 사용자가 Intune에서 iOS 장치를 등록한 후에 수행할 수 있는 작업에 도움이 되는 정보를 제공합니다.
...
이 섹션에서는 사용자가 Intune에서 iOS 장치를 등록할 때 발생할 수 있는 문제를 해결하는 데 도움이 되는 정보를 제공합니다.
