---
title: "iOS에 대해 Microsoft 데이터 수집을 끄는 방법 | Microsoft 문서"
description: 
keywords: 
author: barlanmsft
ms.author: barlan
...
iOS 장치에서 사용 현황 데이터의 수집을 해제하려는 경우 **Settings(설정)**를 열고 **Company Portal(회사 포털)**을 탭한 후 **Usage Data(사용 현황 데이터)**를 끕니다.
