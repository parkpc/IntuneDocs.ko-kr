...
title: Intune에서 Windows Phone 8 장치 등록 | Microsoft Intune
description:
keywords:
author: Staciebarker
manager: jeffgilb
...
# Intune에서 Windows Phone 8 장치 등록
...
Windows Phone 8 장치를 등록하려면:

1.  장치에서 **설정** &gt; **회사 앱**을 탭합니다.

2.  **계정 추가**를 탭한 다음 회사 계정을 사용하여 로그인합니다.

3.  계정이 성공적으로 추가되었으면 회사 앱 또는 허브를 설치하라는 메시지가 표시됩니다. 관련 확인란을 선택했는지 확인한 다음 **완료**를 탭합니다.

설치되면 앱 목록에 회사 포털이 나타납니다.
