...
조직에서는 Windows 코드 무결성 사용을 요구합니다. 이 기능은 장치에서 드라이버와 시스템 파일을 확인하여 보안이 유지되도록 지원합니다.
...
PC를 사용하는 경우 IT 관리자에게 문의할 수 있습니다. 그렇지 않으면 [보안 부팅 사용 안 함](https://msdn.microsoft.com/library/windows/hardware/dn898540(v=vs.85).aspx) 페이지에서 "보안 부팅을 다시 사용하도록 설정하려면" 섹션을 참조하여 직접 보안 부팅을 사용하도록 설정하세요.
