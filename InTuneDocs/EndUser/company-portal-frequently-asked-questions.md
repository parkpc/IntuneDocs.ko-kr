...
Microsoft Intune 회사 포털을 통해 회사 또는 학교의 데이터 및 앱에 액세스할 수 있습니다. 다음과 같은 2가지 방법으로 회사 포털을 사용할 수 있습니다.
...
장치에서 회사 포털 앱을 사용하여 수행할 수 있는 작업과 회사 포털 웹사이트를 사용하여 수행할 수 있는 작업을 비교하여 보려면 다음 링크 중 하나를 선택하세요.
...
IT 관리자가 장치에서 볼 수 있는 항목과 볼 수 없는 항목에 대해 알아보려면 다음 중 사용하는 장치 유형에 해당하는 링크를 사용하세요.
...
컴퓨터 또는 장치를 *재설정*하면 회사 포털에서 컴퓨터 또는 장치를 초기화합니다. 장치를 초기화하면 장치에서 모든 회사 및 개인 데이터가 제거됩니다! 장치를 잃어버린 경우 회사 포털 웹 사이트에서 원격으로 장치를 초기화할 수도 있습니다.

장치를 재설정하는 방법을 알아보려면 다음 링크 중 하나를 선택하세요.
