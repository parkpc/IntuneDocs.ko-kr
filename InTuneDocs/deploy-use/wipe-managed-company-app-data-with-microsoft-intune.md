...
1.  Azure 포털에 로그인하고 **추가 서비스** > **기타** > **Intune**을 선택합니다.

2.  Intune 블레이드에서 **앱 관리**를 선택합니다.

3.  **새 초기화 요청**을 선택합니다. 그러면 **새 초기화 요청** 블레이드가 열립니다.
...
5.  **장치**를 선택합니다.  그러면 **장치** 블레이드가 열리고 선택한 사용자와 관련된 모든 장치가 나열됩니다.  초기화하려는 장치를 선택합니다.

6.  이제 **새 초기화 요청** 블레이드로 전환됩니다. 초기화 요청을 수행하려면 **확인**을 클릭합니다. 서비스에서 장치의 각 보호된 앱에 대해 별도의 초기화 요청을 만들고 추적합니다.
...
**초기화 요청** 타일에서는 초기화 요청의 전반적인 상태를 표시하고, 보류 중인 요청 및 오류의 수가 포함된 요약된 보고서가 있습니다. 세부 정보를 확인하려면 다음 단계를 따릅니다.

1.  Intune 블레이드에서 **앱 관리**를 선택합니다.
