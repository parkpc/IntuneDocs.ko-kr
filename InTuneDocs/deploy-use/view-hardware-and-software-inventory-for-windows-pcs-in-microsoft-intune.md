---
title: "Windows PC에 대한 하드웨어 및 소프트웨어 인벤토리 보기 | Microsoft Intune"
description: "Intune으로 관리하는 Windows PC에 대한 하드웨어 및 소프트웨어 정보를 확인하는 방법입니다."
keywords: 
author: staciebarker
ms.author: stabar
manager: angrobe
...
-   관리하는 컴퓨터의 하드웨어 성능에 대한 정보를 나열하는 보고서

-   각 컴퓨터에 설치된 소프트웨어를 나열하는 보고서

-   보고서의 현재 데이터를 확인하기 위해 컴퓨터 인벤토리를 새로 고치는 방법

## <a name="to-display-information-about-computers-you-manage"></a>관리하는 컴퓨터에 대한 정보를 표시하려면
...
## <a name="to-display-software-installed-on-computers-you-manage"></a>관리하는 컴퓨터에 설치된 소프트웨어를 표시하려면
