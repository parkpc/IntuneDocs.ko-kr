---
title: "모바일 응용 프로그램 관리를 위해 앱 준비 | Microsoft 문서"
...
# <a name="decide-how-to-prepare-apps-for-mobile-application-management-with-microsoft-intune"></a>Microsoft Intune으로 모바일 응용 프로그램 관리용 앱을 준비하는 방법 결정
