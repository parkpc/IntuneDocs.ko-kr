...
4.  確認ダイアログ ボックスで、 **[はい]** をクリックしてポリシーをすぐに展開するか、 **[いいえ]** をクリックして展開せずにポリシーを作成します。
...
1.  [Microsoft Intune 管理コンソール](https://manage.microsoft.com/)で、[ **ポリシー**] をクリックし、管理するポリシーを参照して選択します。
...
### デバイスのポリシーを更新して最新の状態に保つには (Intune クライアント ソフトウェアを実行している Windows PC にのみ適用されます)
