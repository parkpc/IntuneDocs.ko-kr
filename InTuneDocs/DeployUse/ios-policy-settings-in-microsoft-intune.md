...
|**잠금 화면에서 제어 센터 허용**|장치가 잠겨 있을 때 제어 센터 앱에 액세스할 수 있는지 여부를 제어합니다.|
|**잠금 화면에서 알림 보기 허용**|사용자에게 잠금 화면에서 알림 보기에 대한 액세스를 허용합니다.|
|**잠금 화면에서 오늘 보기 허용**|장치가 잠겨 있을 때 알림을 볼 수 있는지 여부를 제어합니다.|
...
|**다른 디바이스에서 작업을 계속하도록 핸드오프 허용**|핸드오프를 통해 다른 iOS에서 iOS 장치 또는 Mac OS X 장치에서 시작하는 작업을 계속할 수 있습니다.|
...
|**쿠키 허용**|장치 웹 브라우저가 쿠키를 사용할 수 있습니다.|
|**Java 스크립팅 허용**|Java 스크립트를 브라우저에서 실행할 수 있습니다.|
|**사기 경고 허용**|장치 브라우저에서 사기 경고를 허용합니다.|
...
|**사용자가 iBook 스토어에서 'Erotica'로 플래그가 지정된 콘텐츠를 다운로드하도록 허용**|사용자가 범주가 ‘Erotic’로 지정된 책을 다운로드하도록 허용합니다.|
...
|**발신 AirPlay 요청에 페어링 암호 필요**|Airplay를 사용하면 다른 Apple 장치로 다른 콘텐츠를 스트리밍할 수 있습니다. 다른 장치에 연결하기 위해 페어링 암호가 필요하면 이 설정을 사용합니다.|
...
|설정 이름|세부 정보|
|----------------|--------------------|
|**장치가 감독 모드에 있을 경우 활성화 잠금 허용**|감독된 iOS 장치에서 활성화 잠금을 사용하도록 설정합니다.|
