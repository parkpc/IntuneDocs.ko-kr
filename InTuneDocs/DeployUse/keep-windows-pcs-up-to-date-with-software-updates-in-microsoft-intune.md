...
다음 표에서는 정책에서 구성할 수 있는 값과 정책을 사용자 지정하지 않은 경우 사용되는 권장 값을 보여 줍니다. 이러한 설정은 **업데이트** 섹션에서 찾아볼 수 있습니다.
  ...
  |정책 설정|세부 정보|
    ...
    |**¿¹¾àµÈ ¾÷µ¥ÀÌÆ® ¹× ÀÀ¿ë ÇÁ·Î±×·¥À» ¼³Ä¡ÇÑ ÈÄ Windows ´Ù½Ã ½ÃÀÛ Áö¿¬(ºÐ)** |예약된 업데이트 및 응용 프로그램을 설치한 후 Windows의 다시 시작 대기 시간(1 - 30분)을 지정합니다.<br /><br />권장 값: **15분** |
...
### 관리 컴퓨터에서 사용할 수 있도록 설정할 제품 범주 및 업데이트 분류 구성
...
### 소프트웨어 업데이트에 대한 자동 승인 규칙을 구성하려면
