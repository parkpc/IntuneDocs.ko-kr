...
title: 모바일 장치에 앱 추가 | Microsoft Intune
description:
keywords:
author: robstackmsft
manager: jeffgilb
...
# Microsoft Intune에서 모바일 장치에 앱 추가
...
3.  **소프트웨어 설명** 페이지에서 다음 항목을 구성합니다.
    ...
    > [!TIP] 사용하는 설치 관리자 유형에 따라 이러한 값 중 일부는 자동으로 입력되어 있을 수 있습니다.
