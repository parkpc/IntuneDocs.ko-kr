...
# Intune으로 Android for Work 장치에 앱을 배포하는 방법
...
## Google Play for Work 스토어에서 앱 동기화
...
## Google Play for Work 스토어에서 LOB(기간 업무) 앱 게시 후 동기화 

1. Google Play Developer 콘솔 [play.google.com/apps/publish](play.google.com/apps/publish)로 이동합니다.
