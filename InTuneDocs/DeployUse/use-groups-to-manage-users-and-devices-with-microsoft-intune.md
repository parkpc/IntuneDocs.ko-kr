...
### 기존 사용자 및 장치 그룹은 어떻게 되나요?
 만들었던 사용자 및 장치 그룹은 Azure AD 보안 그룹으로 마이그레이션됩니다. 마이그레이션 시 배포에 사용자 및 장치 그룹을 사용 중인 경우에는 모든 사용자 그룹과 같은 기본 Intune 그룹만 마이그레이션됩니다. 그룹 일부에 대한 마이그레이션은 좀 더 복잡할 수 있습니다. 마이그레이션을 위해 추가 단계가 필요할 경우 안내해 드리겠습니다.
...
-   새 그룹을 만들 때 구성원 또는 그룹을 제외할 수 없습니다. 그러나 Azure AD 동적 그룹을 사용하면 고급 규칙을 만들 수 있는 특성으로 조건에 따라 멤버를 제외할 수 있습니다.
