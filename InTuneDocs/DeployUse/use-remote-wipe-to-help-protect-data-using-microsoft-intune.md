...
|관리되는 Google Play 앱|앱 데이터가 제거됩니다. 앱은 제거되지 않습니다. 앱 외부(SD 카드 등)의 MAM 암호화로 보호되는 데이터는 암호화 상태를 유지하지만 제거되지 않습니다.|앱 데이터가 제거됩니다. 앱은 제거되지 않습니다. 앱 외부(SD 카드 등)의 MAM 암호화로 보호되는 데이터는 암호화 상태를 유지하지만 제거되지 않습니다.|
|관리되는 LOB(기간 업무) 앱|앱 데이터가 제거됩니다. 앱은 제거되지 않습니다. 앱 외부(SD 카드 등)의 MAM 암호화로 보호되는 데이터는 암호화 상태를 유지하지만 제거되지 않습니다.|앱 데이터가 제거됩니다. 앱은 제거되지 않습니다. 앱 외부(SD 카드 등)의 MAM 암호화로 보호되는 데이터는 암호화 상태를 유지하지만 제거되지 않습니다.|
...
|AAD(Azure Active Directory) 가입 취소|아니요|아니요|AAD 레코드가 제거됨|AAD 레코드가 제거됨|
