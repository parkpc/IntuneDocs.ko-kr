...
ここでは、Intune 試用版のセットアップと、iOS デバイスの PIN ポリシーを構成する方法について、ステップ バイ ステップで説明します。 試用できるその他の一般的な Intune 評価タスクの一覧は、「[Microsoft Intune の一般的な評価タスク](common-microsoft-intune-evaluation-tasks.md)」を参照してください。.
...
1.  Windows PC を使用して、**Internet Explorer** (IE) を右クリックし、**[InPrivate ブラウズ]** をクリックします。.
...
2.  iOS デバイスの登録を有効化します。 このプロセスは、Apple Push Notification サービス (APNs) と Intune サブスクリプションの間の信頼された証明書をセットアップします。
    ...
    7.  Apple の使用条件を読み、チェック ボックスをオンにし、**[同意する]** をクリックします。.
