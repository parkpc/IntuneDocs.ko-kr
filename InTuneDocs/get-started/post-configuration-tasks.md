...
-   **Intune 보고서:** Microsoft Intune에서는 장치를 모니터링하는 데 사용할 수 있는 경고 및 보고서뿐만 아니라, 장치 초기화 등 장치에 영향을 주는 작업 및 소프트웨어 라이선스 상태에 대한 경고와 보고서도 제공합니다.  보고에 대한 자세한 내용은 [보고서를 사용하는 Microsoft Intune 작업 이해](/intune/deploy-use/understand-microsoft-intune-operations-by-using-reports)를 참조하세요.
