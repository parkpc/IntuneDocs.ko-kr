...
다음과 같은 방법으로 Intune 평가판을 유료 구독으로 변환할 수 있습니다(/intune/setup-steps).
-   **Intune 구독** - 사용자별로 사용이 허가됩니다. 자세한 내용은 [Microsoft Intune 구매 방법](/intune/setup-steps)을 참조하고 Intune을 시작할 때 추가 구성 단계를 읽어보세요.
