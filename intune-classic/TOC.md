...
# 계획 및 디자인
## [배포 계획, 설계 및 구현](plan-design/introduction.md)
...
## [마이그레이션](plan-design/intune-mdm-migration-guide.md)
### [1 단계: MDM용 Intune 준비](plan-design/migration-phase1-prepare-intune-for-mobile-device-management.md)
#### [기본 설정](plan-design/migration-phase1-basic-setup.md)
#### [장치 및 앱 관리 정책 구성](plan-design/migration-phase1-configure-device-and-app-management-policies.md)
#### [앱 보호 정책 구성](plan-design/migration-phase1-configure-app-protection-policies.md)
#### [특별 마이그레이션 고려 사항](plan-design/migration-phase1-special-migration-considerations.md)
### [2 단계: 마이그레이션 캠페인](plan-design/migration-phase2-migration-campaign.md)
#### [통신 계획](plan-design/migration-phase2-communication-plan.md)
#### [도입 촉진](plan-design/migration-phase2-drive-end-user-adoption-with-conditional-access.md)
#### [일반적인 마이그레이션 주기](plan-design/migration-phase2-typical-migration-cycle.md)

# [새로운 기능](whats-new/whats-new-in-microsoft-intune.md)
## [앱 UI의 새로운 기능](whats-new/whats-new-in-intune-app-ui.md)
## [Azure Tools의 새로운 기능](/intune/whats-new?toc=/intune-classic/toc.json&bc=/enterprise-mobility/toc.json)
...
### [장치 수명 주기](deploy-use/overview-of-device-lifecycle-in-microsoft-intune.md)
### [앱 수명 주기](deploy-use/overview-of-app-lifecycle-in-microsoft-intune.md)
...
### [MAM용 기간 업무 준비](deploy-use/decide-how-to-prepare-apps-for-mobile-application-management-with-microsoft-intune.md)
#### [iOS 앱 줄 바꿈](deploy-use/prepare-ios-apps-for-mobile-application-management-with-the-microsoft-intune-app-wrapping-tool.md)
#### [Android 앱 줄 바꿈](deploy-use/prepare-android-apps-for-mobile-application-management-with-the-microsoft-intune-app-wrapping-tool.md)
...
### [MAM을 사용한 앱이 포함된 Android에 대한 최종 사용자 환경](deploy-use/user-experience-for-mam-enabled-android-apps-with-microsoft-intune.md)
### [MAM을 사용한 앱이 포함된 iOS에 대한 최종 사용자 환경](deploy-use/user-experience-for-mam-enabled-ios-apps-with-microsoft-intune.md)
...
## [Microsoft Intune 앱 SDK 시작](develop/intune-app-sdk-get-started.md)
## [iOS용 Intune 앱 SDK 개발자 가이드](develop/intune-app-sdk-ios.md)
## [Android용 Intune 앱 SDK 개발자 가이드](develop/intune-app-sdk-android.md)
## [Intune 앱 SDK Cordova 플러그 인](develop/intune-app-sdk-cordova.md)
## [Intune 앱 SDK Xamarin 구성 요소](develop/intune-app-sdk-xamarin.md)
