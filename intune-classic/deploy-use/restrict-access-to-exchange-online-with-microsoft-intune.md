...
|----------------------------------------------------------------------|----------------|-----------|------------------------|-------------------------|
| <strong>Microsoft Intune 및 Exchange ActiveSync에 의해 관리</strong> |      예       |    예    |  값이 표시됨  | 메일 액세스가 허용됨 |
...
7. **제외된 그룹**아래에서 이 정책에서 제외된 사용자의 Active Directory 보안 그룹을 선택합니다. 사용자가 대상이 지정된 그룹과 제외된 그룹에 모두 속할 경우 정책에서 제외됩니다.

8. 작업이 완료되면 **저장**을 선택합니다.
