                            ...
                            <div class="cardSize">
                                <div class="cardPadding">
                                    <div class="card">
                                        ...
                                        <div class="cardText">
                                            <h3>Azure에서 Intune 기능은 어디에 있나요?</h3>
                                            <p>클래식 콘솔의 Intune에 익숙한 경우 이 문서는 Azure에서 Intune 기능을 찾는 데 도움이 됩니다.</p>
                                        </div>
                                    </div>
                                </div>
                            </div>
...
<!--                        <li>
                        ...
                        <li class="fullSpan">
                            <div class="container">
                                <h3><a href="/intune/what-is-intune">전체 Intune 문서</a>를 참조하세요.</h3>
                            </div>
                        </li>
                    </ul>
                </li>
...
<!--                        <li>
                        ...
                        <li class="fullSpan">
                            <div class="container">
                                <h3><a href="/intune/what-is-intune">전체 소개 문서</a>를 참조하세요.</h3>
                            </div>
                        </li>
                    </ul>
                </li>
...
<!--                        <li>
                        ...
                        <li class="fullSpan">
                            <div class="container">
                                <h3><a href="/intune-classic/plan-design/introduction">전체 배포 계획 문서</a>를 참조하세요.</h3>
                            </div>
                        </li>
                    </ul>
                </li>
...
<!--                        <li>
                        ...
                        <li class="fullSpan">
                            <div class="container">
                                <h3><a href="/intune/device-enrollment">전체 방법 문서</a>를 참조하세요.</h3>
                            </div>
                        </li>
                    </ul>
                </li>
                <li>
                    ...
                    <ul id="manage-troubleshoot" class="cardsC">
                        ...
                        <li class="fullSpan">
                            <div class="container">
                                <h3><a href="/intune-classic/troubleshoot/general-troubleshooting-tips-for-microsoft-intune">전체 문제 해결 문서</a>를 참조하세요.</h3>
                            </div>
                        </li>
                    </ul>
                </li>
            ...
            <ul id="sdkstools">
                <li>
                    ...
                    <ul id="sdkstools-all" class="cardsC">                       
                        ...
                        <li class="fullSpan">
                            <div class="container">
                                <h3>전체 문서를 찾고 있나요? <a href="/intune-classic/understand-explore/introduction-to-microsoft-intune">전체 Intune 문서</a>를 참조하세요.</h3>
                            </div>
                        </li>
                    </ul>
                </li>
