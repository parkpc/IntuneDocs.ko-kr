...
이 항목에서는 장치 등록 문제 해결을 위한 제안 사항을 제공합니다. 이 정보로 문제가 해결되지 않는 경우 [Microsoft Intune에 대한 지원을 받는 방법](https://docs.microsoft.com/intune/troubleshoot/how-to-get-support-for-microsoft-intune)을 참조하여 도움을 얻을 수 있는 다른 방법을 찾아보세요.
...
사용자에게 [장치에 필요한 인증서가 없는 경우](https://docs.microsoft.com/intune/enduser/your-device-is-missing-a-required-certificate-landing-android#your-device-is-missing-a-certificate-required-by-your-it-administrator)의 지침을 따르도록 합니다. 사용자가 해당 지침을 따른 후에도 오류가 계속 표시되면 해결 방법 2를 시도해 봅니다.
...
최종 사용자에게 표시될 수 있는 [iOS 등록 오류](https://docs.microsoft.com/intune/enduser/you-see-errors-while-trying-to-enroll-your-device-in-intune-ios) 목록을 볼 수 있습니다. 이 목록에서는 최종 사용자에게 표시될 수 있는 오류 메시지 및 문제를 해결하기 위해 수행하는 단계에 대한 정보를 제공합니다.
...
이 오류는 컴퓨터가 이전에 등록되었거나, 등록된 컴퓨터의 복제 이미지를 사용하기 때문에 발생할 수 있습니다. 이전 계정의 계정 인증서가 컴퓨터에 아직 존재합니다.
