---
title: "Intune에 Windows 스토어 앱을 추가하는 방법 | Intune Azure 미리 보기 | Microsoft Docs"
description: "Intune Azure 미리 보기: Intune에 Windows 스토어 앱을 추가하는 방법을 알아봅니다."
keywords: 
author: robstackmsft
ms.author: robstack
manager: angrobe
...
# <a name="how-to-add-windows-store-apps-to-intune"></a>Intune에 Windows 스토어 앱을 추가하는 방법
