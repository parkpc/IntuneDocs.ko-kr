...
오류 세부 정보는 장치의 _진단 로그_라는 특수 문서에 저장됩니다. 회사 포털 앱에 로그를 업로드하는 경우 먼저 앱에서 작동하는 Microsoft 개발자에게 보냅니다. 앱의 기능을 개선하고 향후 오류를 방지하려면 로그를 사용합니다. 특정 오류에 대한 인시던트 ID는 회사 지원 담당자와 공유하기 위해 사용자에게 제공됩니다.  
