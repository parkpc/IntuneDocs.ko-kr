---
title: "Apple 장치에 대한 Microsoft 데이터 수집을 해제하는 방법 | Microsoft Docs"
description: 
keywords: 
author: barlanmsft
ms.author: barlan
...
iOS 장치에서 사용 현황 데이터의 수집을 해제하려는 경우 **Settings(설정)**를 열고 **Company Portal(회사 포털)**을 탭한 후 **Usage Data(사용 현황 데이터)**를 끕니다. macOS 장치의 경우 **회사 포털** 메뉴 > **기본 설정**을 차례로 연 다음 **Microsoft의 사용 데이터 수집을 허용합니다.**를 선택 취소합니다.
